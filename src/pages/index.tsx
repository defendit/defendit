...
function CallToActionButtons() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-evenly gap-4 mt-6 w-auto p-3 font-semibold text-sm md:text-xl break-keep">
      ...
      const viewServicesClasses = "border border-black dark:border-gray-200 text-black dark:text-white px-6 py-4 rounded-md hover:bg-blue-500 hover:text-white hover:dark:bg-sky-500/60  hover:border-blue-700 hover:dark:border-sky-600 glow-hover";
        return (
          <Link
            key={index}
            href={button.link}
