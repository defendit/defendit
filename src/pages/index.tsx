...
function CallToActionButtons() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-evenly gap-4 mt-6 w-auto p-3 font-semibold md:text-xl">
  ...
  return (
    ...
    >
      ...
      <section className="relative z-10 flex flex-col items-center justify-center w-full">
        <h2 className="text-2xl md:text-3xl font-bold">{services_cta.headline}</h2>
        <CallToActionButtons />
      </section>
    </main>
  );
