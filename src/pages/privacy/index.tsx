...
export default function Privacy() {
  return (
   <LegalPage>
        ...
        <p className="mb-6">
          www.wedefendit.com (the &quot;Site&quot;) is owned and operated by Defend I.T. Solutions&trade; LLC.
          <br />
          <br />
          Contact:{" "}
          <a
            href="mailto:info@wedefendit.com"
            className="text-blue-600 underline"
          >
            info@wedefendit.com
          </a>
          <br />
          Address: 3035 SE MARICAMP RD UNIT 104-205, Ocala, FL, 34471
        </p>
        ...
        <p>
          Customer data is stored for seven years. You will be notified if stored longer.
        </p>
        ...
        <p>
          ...
          <br />
          Optional PGP email is offered. Access is controlled via strong authentication.
        </p>
        <p>
          We cannot guarantee absolute security due to the inherent nature of the internet.
        </p>

        <h2 className="text-xl font-bold uppercase border-b my-4">Children</h2>
        <p>
          Minimum age: 18. We do not knowingly collect data from children under 13. If discovered, it will be deleted.
        </p>
        ...
        <p>
          <strong>Service Scope:</strong> IT support, consulting, installation only as per agreement.
        </p>
        <p>
          <strong>Client Data:</strong> Stored securely, not shared or sold. Retained 7 years.
        </p>
        <p>
          <strong>Secure Communication:</strong> PGP or HTTPS-based as needed.
        </p>
        <p>
          <strong>Limitation of Liability:</strong> No responsibility for indirect damages.Liability limited to previous 30 days of service cost.
        </p>
