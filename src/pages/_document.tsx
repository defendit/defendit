  ...
  return (
    <Html lang="en" className=" bg-gray-100 dark:bg-gray-900 text-black dark:text-gray-300">
      <Head>
        ...
        <meta property="og:description" content="Cybersecurity & IT services delivered on-site to homes and businesses in The Villages and Ocala, FL." />
        <meta property="og:image" content="https://www.wedefendit.com/og-image.jpg" />
