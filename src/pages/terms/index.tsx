  ...
  return (
    <LegalPage>
      ...
      <p className="mb-6">
        ...
        the use of <strong>www.wedefendit.com</strong> (the &quot;Site&quot;).
        This Site is owned and operated by Defend I.T. Solutions LLC. It is a
        service-based business website offering IT support, cybersecurity
        services, and a security appliance for residential and small business
        clients.
      </p>
      ...
      <p>
        ...
        Defend I.T. Solutions LLC and the Site&apos;s creators. This includes
        but is not limited to images, text, logos, documents, downloadable files
      ...
      <p>
        ...
        users agree they are over 18. We do not assume legal responsibility for
        false age claims.
      </p>
      ...
      <p>
        If we believe you are violating these Terms, we may suspend or terminate
        access and pursue legal action.
      </p>
      ...
      <p>
        Defend I.T. Solutions LLC and affiliates are not liable for any claims,
        damages, or expenses arising from your use of the Site.
      </p>
      ...
      <p>
        ...
        affiliates from claims and liabilities arising from your use of the Site
      ...
      <p>
        ...
        binding arbitration if necessary. Both parties will share costs equally.
      </p>
      <p>
      ...
      <ul className="list-disc ml-6 my-2">
        ...
        <li>
          <strong>Right to Refuse Access:</strong> We may block users violating
          terms or engaging in abuse.
        </li>
        <li>
        ...
        <li>
          <strong>Third-Party Links:</strong> We are not responsible for content
